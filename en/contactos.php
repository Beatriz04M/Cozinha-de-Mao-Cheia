...
<head>
    ...
    <title>Contacts - Cozinha de Mão Cheia</title>
...
<body>
    ...
    <!-- Mapa -->
    <div id="Contactos">
        <h2 class="text-center"><strong>Come visit us!</strong></h2>
    ...
    <div class="feedback-section">
        ...
        <p class="text-center mb-4">Help us improve your experience!</p>
        ...
        <form action="feedback.php" method="POST">
            ...
            <div class="mb-3">
                ...
                <textarea class="form-control" id="mensagem" name="mensagem" rows="5" placeholder="Tell us about your experience..." required></textarea>
            </div>
            <div class="mb-4">
            ...
            <div class="text-center">
                <button type="submit" class="feedback-btn btn-outline-dark">Submit Feedback</button>
            </div>
        </form>
    </div>
